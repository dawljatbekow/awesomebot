...
void fahre_richtung(int r){
	...
	case 0: richtiglenken(-200/2, 30);	break;  //0=Drehung nach links
	case 1: richtiglenken( 200/2, 30);	break;	//1=Drehung nach rechts
	case 2: break;								//2=keine Drehung, da Ausgangslage nach vorne zeigt
	case 3: richtiglenken( 200, 30);	break;	//3=Drehung nach hinten
	}
